...
`[Ctrl+X]` はタブ・ペイン操作の**プレフィックスキー**として機能します。`[Ctrl+X]` を押すとヒント（`C-x [ m:Menu f:Find r:Recent t:New ←/→:Other k:Kill l:Lock | o:Otherp 0:closep 1:closeotherp 2:Splitp | 4:detach 5:Dup ]`）がステータス行に表示され、続けて以下のキーを入力します。
